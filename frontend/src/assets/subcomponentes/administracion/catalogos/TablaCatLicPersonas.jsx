      ...
      <div className="contenedor-activos">
        <div className="row-activos">
          <div className="asigPerifericos">
            <h1>Catalogo Licencias Persona</h1>
          </div>
          <div className="contbuscador-asigEquipos" style={{ marginLeft: '-2.5vw' }}>
            <input
          ...
          <div className="contenedor-tabla-activos" >
            <table className="table-asigEquipos">
              <thead>
                <th style={{ padding: '0vw 0vw 0vw 12vh' }}>ID Licencia</th>
                <th>Nombre</th>
...
export default TablaCatLicPersonas;
