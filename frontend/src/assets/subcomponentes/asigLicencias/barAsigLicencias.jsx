...
export default function BarAsigLicencias({ onClickTabla }) {
    ...
    return (
        <div className="bar">
            <div id="licenciaPersonas" className={tablaSeleccionada === 'licenciaPersonas' ? 'active' : ''} onClick={handleTablaClick}>Asignacion Licencias Personas</div>
            <div id="licenciaEquipos" className={tablaSeleccionada === 'licenciaEquipos' ? 'active' : ''} onClick={handleTablaClick}>Asignacion Licencias Equipos</div>
        </div>
    );
}
