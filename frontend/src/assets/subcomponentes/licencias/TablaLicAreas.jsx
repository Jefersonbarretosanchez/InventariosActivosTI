...
import { faFileLines, faPlus, faPenToSquare, faMagnifyingGlass, faCircleArrowUp } from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="contenedor-tabla-activos">
            <table className="table-asigEquipos">
              <thead>
                ...
                <th>Estado</th>
                <th style={{ padding: '1.5vh 0vw 1.6vh 12vh' }}>Acciones</th>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    >
                      <FontAwesomeIcon icon={faCircleArrowUp} style={{ width: '20px', height: '17.5px' }} />
                    </button>
                  </td>
                </tr>
                <tr>
