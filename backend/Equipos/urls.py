...
urlpatterns = [
    ...
    path('perifericos/', views.PerifericosListCreate.as_view(),
         name='perifericos_create'),  # crear perifericos
    path('estado_perifericos/', views.EstadoPerifericosView.as_view(),
         name='estado_perifericos_create'),  # estado
    path('kit_perifericos/', views.KitPerifericosListCreateView.as_view(),
         name='kit_perifericos_create'),  # crear kit
    path('kit_perifericos/<int:pk>/', views.KitPerifericosDetailView.as_view(),
         name='kit_perifericos_detail'),  # actualizar kit
