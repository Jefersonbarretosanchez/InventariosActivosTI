...
urlpatterns = [
    ...
    path('centro_costos/<int:pk>/',views.CatCentroCostoUpdate.as_view(),name="centro-costos-update"),
    ...
    path('estado_persona/<int:pk>/',views.CatEstadoPersonaUpdate.as_view(),name="estado_persona-update"),
]