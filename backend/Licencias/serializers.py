...
class LicenciaPersonasSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.no_ticket = validated_data.get('no_ticket', instance.no_ticket)
...
class LicenciaEquiposSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        instance.nombre_licencia = validated_data.get('nombre_licencia', instance.nombre_licencia)
        instance.id_estado_licencia = validated_data.get('id_estado_licencia', instance.id_estado_licencia)
        instance.sereal=validated_data.get('sereal',instance.sereal)
        instance.fecha_vencimiento=validated_data.get('fecha_vencimiento',instance.fecha_vencimiento)
        instance.id_contrato = validated_data.get('id_contrato', instance.id_contrato)
        instance.no_ticket = validated_data.get('no_ticket', instance.no_ticket)
...
class LicenciaAreasSerializer(serializers.ModelSerializer):
    ...
    id_responsable=serializers.PrimaryKeyRelatedField(
        queryset=Persona.objects.all())
    id_ceco=serializers.PrimaryKeyRelatedField(
    ...
    def update(self, instance, validated_data):
        ...
        instance.id_contrato = validated_data.get('id_contrato', instance.id_contrato)
        instance.no_ticket = validated_data.get('no_ticket', instance.no_ticket)
        instance.id_responsable = validated_data.get('id_responsable', instance.id_responsable)
